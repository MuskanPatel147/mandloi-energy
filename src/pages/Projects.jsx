    ...
    <div className="projects-page-wrapper site-wrapper">
      ...
      <main className="projects-main-section" id="projects-content">
        <div className="container projects-content-wrapper">
          ...
          {/* ================================================================
              Section 2: Our Project Partners (4 Verified Reference Cards)
              ================================================================ */}
          <section
            ref={partnersRef}
            ...
            <div className="projects-partners-grid">
              {PARTNERS_DATA.map((partner, idx) => (
                <article
                  ...
                  aria-label={`Project partner: ${partner.name}`}
                >
                  {/* Top: Logo Container with Subtle Hover Scale */}
                  <div className="partner-logo-box">
                    {partner.logoType === 'bpcl' && (
                      <div className="partner-logo-bpcl" aria-label="Bharat Petroleum">
